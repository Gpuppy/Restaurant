 ...
 */
final class Version20230518160621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meals (id INT AUTO_INCREMENT NOT NULL, meals_id INT NOT NULL, image VARCHAR(255) DEFAULT NULL, image_file VARCHAR(255) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', name VARCHAR(255) NOT NULL, price INT NOT NULL, date INT NOT NULL, file INT NOT NULL, INDEX IDX_E229E6EA88A25CA2 (meals_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
